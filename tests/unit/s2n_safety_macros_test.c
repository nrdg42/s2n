...
static s2n_result RESULT_PRECONDITION_harness(uint32_t v)
{
    RESULT_PRECONDITION(v != 1);
    return S2N_RESULT_OK;
}

static s2n_result RESULT_POSTCONDITION_harness(uint32_t v)
{
    RESULT_POSTCONDITION(v != 1);
    return S2N_RESULT_OK;
}
...
static int POSIX_PRECONDITION_harness(uint32_t v)
{
    POSIX_PRECONDITION(v != 1);
    return S2N_SUCCESS;
}

static int POSIX_POSTCONDITION_harness(uint32_t v)
{
    POSIX_POSTCONDITION(v != 1);
    return S2N_SUCCESS;
}
...
static const char* PTR_PRECONDITION_harness(uint32_t v)
{
    PTR_PRECONDITION(v != 1);
    return "ok";
}

static const char* PTR_POSTCONDITION_harness(uint32_t v)
{
    PTR_POSTCONDITION(v != 1);
    return "ok";
}
...
int main(int argc, char **argv)
{
    ...
    EXPECT_OK(RESULT_PRECONDITION_harness(0));
    EXPECT_ERROR_WITH_ERRNO(RESULT_PRECONDITION_harness(1), S2N_ERR_PRECONDITION_VIOLATION);
    EXPECT_OK(RESULT_PRECONDITION_harness(2));

    /* RESULT_POSTCONDITION(condition) */
    EXPECT_OK(RESULT_POSTCONDITION_harness(0));
    EXPECT_ERROR_WITH_ERRNO(RESULT_POSTCONDITION_harness(1), S2N_ERR_POSTCONDITION_VIOLATION);
    EXPECT_OK(RESULT_POSTCONDITION_harness(2));
    ...
    EXPECT_SUCCESS(POSIX_PRECONDITION_harness(0));
    EXPECT_FAILURE_WITH_ERRNO(POSIX_PRECONDITION_harness(1), S2N_ERR_PRECONDITION_VIOLATION);
    EXPECT_SUCCESS(POSIX_PRECONDITION_harness(2));

    /* POSIX_POSTCONDITION(condition) */
    EXPECT_SUCCESS(POSIX_POSTCONDITION_harness(0));
    EXPECT_FAILURE_WITH_ERRNO(POSIX_POSTCONDITION_harness(1), S2N_ERR_POSTCONDITION_VIOLATION);
    EXPECT_SUCCESS(POSIX_POSTCONDITION_harness(2));
    ...
    EXPECT_NOT_NULL(PTR_PRECONDITION_harness(0));
    EXPECT_NULL_WITH_ERRNO(PTR_PRECONDITION_harness(1), S2N_ERR_PRECONDITION_VIOLATION);
    EXPECT_NOT_NULL(PTR_PRECONDITION_harness(2));

    /* PTR_POSTCONDITION(condition) */
    EXPECT_NOT_NULL(PTR_POSTCONDITION_harness(0));
    EXPECT_NULL_WITH_ERRNO(PTR_POSTCONDITION_harness(1), S2N_ERR_POSTCONDITION_VIOLATION);
    EXPECT_NOT_NULL(PTR_POSTCONDITION_harness(2));
