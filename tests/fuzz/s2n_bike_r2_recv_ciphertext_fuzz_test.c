...
/* Target Functions: s2n_kem_recv_ciphertext s2n_kem_decapsulate BIKE1_L1_R2_crypto_kem_dec */
...
#define KAT_FILE_NAME "../unit/kats/bike_r2.kat"

/* This fuzz test uses the first private key (count = 0) from tests/unit/kats/bike_r2.kat.
