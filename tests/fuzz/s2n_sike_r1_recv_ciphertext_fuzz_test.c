...
/* Target Functions: s2n_kem_recv_ciphertext s2n_kem_decapsulate SIKE_P503_r1_crypto_kem_dec */
...
#define KAT_FILE_NAME "../unit/kats/sike_r1.kat"

/* This fuzz test uses the first private key (count = 0) from tests/unit/kats/sike_r1.kat.
