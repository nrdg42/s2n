...
{
    POSIX_PRECONDITION(S2N_MEM_IS_READABLE(out, sizeof(*out)));
    switch(hash_alg) {
...
{
    POSIX_PRECONDITION(S2N_MEM_IS_READABLE(block_size, sizeof(*block_size)));
    switch(alg) {
...
{
    POSIX_PRECONDITION(s2n_hash_state_is_valid(state));
...
int s2n_hash_new(struct s2n_hash_state *state)
{
    ...
    POSIX_POSTCONDITION(s2n_hash_state_is_valid(state));
    return S2N_SUCCESS;
}
...
{
    POSIX_PRECONDITION(s2n_hash_state_is_valid(state));
    POSIX_PRECONDITION(S2N_MEM_IS_READABLE(data, size));
...
{
    POSIX_PRECONDITION(s2n_hash_state_is_valid(state));
    POSIX_PRECONDITION(S2N_MEM_IS_READABLE(out, size));
...
{
    POSIX_PRECONDITION(s2n_hash_state_is_valid(to));
    POSIX_PRECONDITION(s2n_hash_state_is_valid(from));
